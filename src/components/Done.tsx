import DoneLogo from "../assets/icons_FEtask/Done.svg"
...
const Done = () => {
    ...
    return (
        <div>
            <div className="todo">
                <img src={DoneLogo} alt="icon" height={20} width={20}/>
                <h1>
                    Done <span className="num">3</span>
                </h1>
            ...
            <div className="container">
                {tickets.slice(0, 5).map((ticket) => { // Only show the first two tickets
